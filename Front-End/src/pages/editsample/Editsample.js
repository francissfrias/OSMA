      ...
      .then((response) => {
        if (response.data != null) {
          this.setState({
            ...
            yearStarted: response.data.yearStarted,
            phoneNumber: response.data.phoneNumber,
            telephoneNumber: response.data.telephoneNumber,
            primaryAddress: response.data.primaryAddress,
            province: response.data.province,
            city: response.data.city,
            villageorbarangay: response.data.villageorbarangay,
            zipcode: response.data.zipcode,
            highschoolName: response.data.highschoolName,
            highschoolAddress: response.data.highschoolAddress,
            highschoolYearGraduated: response.data.highschoolYearGraduated,
            elementaryName: response.data.elementaryName,
            elementaryAddress: response.data.elementaryAddress,
            elementaryYearGraduated: response.data.elementaryYearGraduated,
            fatherName: response.data.Avatar.fatherName,
