...
return (
    <div className="studentadd">
            ...
            <Avatar alt="Remy Sharp" src="https://images.theconversation.com/files/38926/original/5cwx89t4-1389586191.jpg?ixlib=rb-1.1.0&q=45&auto=format&w=926&fit=clip" />
            
            <div className="uploadcsssss">
            <input accept="image/*" className={uploadclass.input} id="icon-button-file" type="file" />
           <label htmlFor="icon-button-file">
           <IconButton color="primary" className="uploadcss" aria-label="upload picture" component="span">
           <GetAppIcon className="asdf"/>
            ...
            <form className={classes.root} noValidate autoComplete="off">
             <TextField id="standard-basic" type="name"  label="First Name" onChange={(e)=>{
              setFirstName(e.target.value)
             }} />
             </form>
             <form className={classes.root} noValidate autoComplete="off">
               <TextField id="standard-basic" label="Middle Initial" onChange={(e)=>{
             ...
             <TextField id="standard-basic" type="name" label="Student Number" onChange={(e)=>{
              setStudentNumber(e.target.value)
             }}/></form>
             <form className={classes.root} noValidate autoComplete="off">
             <TextField id="stan  dard-basic" type="email" label="Email" onChange={(e)=>{
              setemail(e.target.value)
             }}/> </form>
             <form className={classes.root} noValidate autoComplete="off">
                <TextField id="standard-basic" type="number" label="Age" onChange={(e)=>{
    ...
    <form className={classes.container}  style={{marginTop:"20px"}} noValidate>
      <TextField
        id="date"
        label="Year Started"
        type="date"
        ...
        <Select
         ...
         >
          ...
          <MenuItem value={'No Comment'}>No Comment</MenuItem>
                ...
                <form className={classes.root} noValidate autoComplete="off">
               <TextField id="standard-basic" type="name"  label="Phone Number" onChange={(e)=>{
              setphoneNumber(e.target.value)
             }}/>
                </form>
                <form className={classes.root} noValidate autoComplete="off">
               <TextField id="standard-basic" type="name"  label="Telephone Number" onChange={(e)=>{
              settelephoneNumber(e.target.value)
             }}/>
                </form>
                <form className={classes.root} noValidate autoComplete="off">
               <TextField id="standard-basic" type="name"  label="Primary Address" onChange={(e)=>{
              setprimaryAddress(e.target.value)
             }}/>
                </form>   
                <form className={classes.root} noValidate autoComplete="off">
               <TextField id="standard-basic" type="name"  label="Province" onChange={(e)=>{
              setprovince(e.target.value)
             }}/>
                </form>   
                <form className={classes.root} noValidate autoComplete="off">
               <TextField id="standard-basic" type="name"  label="City" onChange={(e)=>{
              setcity(e.target.value)
             }}/>
                </form>   
                <form className={classes.root} noValidate autoComplete="off">
               <TextField id="standard-basic" type="name"  label="Village/Barangay" onChange={(e)=>{
              setvillageorbarangay(e.target.value)
             }}/>
                </form>
                <form className={classes.root} noValidate autoComplete="off">
               <TextField id="standard-basic" type="name"  label="Zip Code" onChange={(e)=>{
              ...
              <form className={classes.root} noValidate autoComplete="off">
             <TextField id="standard-basic" type="name"  label="Highschool Name" onChange={(e)=>{
              sethighschoolName(e.target.value)
             }}/>
              </form>

              <form className={classes.root} noValidate autoComplete="off">
             <TextField id="standard-basic" type="name"  label="Highschool Address" onChange={(e)=>{
              sethighschoolAddress(e.target.value)
             }}/>
              </form>   
              <form className={classes.root} noValidate autoComplete="off">
             <TextField id="standard-basic" type="name"  label="Year Graduated:" onChange={(e)=>{
              sethighschoolYearGraduated(e.target.value)
             }}/>
              </form>   
              <form className={classes.root} noValidate autoComplete="off">
             <TextField id="standard-basic" type="name"  label="Elementary School Name" onChange={(e)=>{
              setelementaryName(e.target.value)
             }}/>
              </form>   
              <form className={classes.root} noValidate autoComplete="off">
             <TextField id="standard-basic" type="name" style={{width:250}} label="Elementary School Address" onChange={(e)=>{
             ...
             <TextField id="standard-basic" type="name"  label="Year Graduated:" onChange={(e)=>{
              ...
              <form className={classes.root} noValidate autoComplete="off">
             <TextField id="standard-basic" type="name"  label="Father's Name: " onChange={(e)=>{
              setfatherName(e.target.value)
             }}/>
              </form>
              <form className={classes.root} noValidate autoComplete="off">
             <TextField id="standard-basic" type="name"  label="Father's Occupation" onChange={(e)=>{
              setfatherOccupation(e.target.value)
             }}/>
              </form>
              <form className={classes.root} noValidate autoComplete="off">
             <TextField id="standard-basic" type="name"  label="Mother's Name" onChange={(e)=>{
              setmotherName(e.target.value)
             }}/>
              </form>
              <form className={classes.root} noValidate autoComplete="off">
             <TextField id="standard-basic" type="name"  label="Mother's Occupation" onChange={(e)=>{
              setmotherOccupation(e.target.value)
                ...
                <Button variant="contained" color="primary" style={{fontSize:'12px',backgroundColor: 'teal', }} className="userAddButton"  onClick={submitReview}>
                    Add
                    </Button>
